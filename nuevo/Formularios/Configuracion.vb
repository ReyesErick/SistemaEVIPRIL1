...
Public Class FrmConfiguracion
    ...
    Private Sub btnTestConnection_Click(sender As Object, e As EventArgs) Handles btnTestConnection.Click
        ...
        Try
            ...
            My.Settings.Save()
            cn = New SqlConnection(My.Settings.ConexionTemporal)
        ...
        Catch ex As Exception
            If ex.ToString.Contains("No se encontró el servidor") Then
                MessageBox.Show("El nombre o direccion del servidor no es correcto", "EVIPRIL", MessageBoxButtons.OK, MessageBoxIcon.Error)
            End If
            If ex.ToString.Contains("No se puede abrir la base de datos") Then
                MessageBox.Show("El nombre de la base de datos es incoreccto", "EVIPRIL", MessageBoxButtons.OK, MessageBoxIcon.Error)
            End If
            If ex.ToString.Contains("Error de inicio de sesión del usuario") Then
                MessageBox.Show("El nombre de usuario o contraseña para la base de datos es incorecto", "EVIPRIL", MessageBoxButtons.OK, MessageBoxIcon.Error)
            End If
